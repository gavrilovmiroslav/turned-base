...
public class Transitioner : MonoBehaviour
{
    ...
    public Coroutine TransitionOutCoroutine()
    {
        Destroy(_transitionOrdererObject);
        Transitioner.Instance.FinishTransition();
        return StartCoroutine(Transition(TransitionType.Out));
    }

    public Coroutine TransitionInCoroutine()
    {
        Destroy(_transitionOrdererObject);
        Transitioner.Instance.FinishTransition();
        return StartCoroutine(ActualTransitionIn());
    }
